...
def get_data_via_rs232():
    ...
    for i in range(3):
        res=ser.read()
        a=int.from_bytes(res, byteorder='big')
    res=ser.read(a)
    rs232_data=int.from_bytes(res,byteorder='big')
...
def get_data_via_rs485():
    ...
    for i in range(3):
        ...
        a=int.from_bytes(res, byteorder='big')
    res=ser.read(a)
    rs485_data=int.from_bytes(res,byteorder='big')
...
class secondDialog(QDialog):
    ...
    def maxminvalue(self):
        ...
        if get_data_via_rs232()==get_data_via_rs485():
